...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"显示 {from} 到 {to} 条,总计 {total} 条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.extend($.fn.validatebox.defaults.rules, {
	chineseAndZimu : {// 验证中文和大写字母
		validator : function(value) {
			return /^[\u0391-\uFFE5]+$/i.test(value) & /^[A-Z]+$/i.test(value);
		},
		message : '请输入中文或者大写字母查询。'
	},
	minLength : { // 判断最小长度
